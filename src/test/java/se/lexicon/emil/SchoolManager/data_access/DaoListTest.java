...
public class DaoListTest {
	...
	static String[] adresses = { "Studentvagen 1", "Karlskronavagen 17", "Falkenbergsvagen 22", "Johannesberg 77",
			"Oscarskulle 56" };
	static String[] emails = { "@gmail.com", "@outlook.com", "@lexicon.com", "@bth.se", "@yahoo.com" };

	static String[] courseNames = { "Matematik Introduktion", "Diskret Matematik", "Trigometri", "Kryption 1",
			"kryption 2" };
	...
	public static void setUp() {
		for (int i = 0; i < TEST_ARRAY_LENGTH; i++) {
			...
			courses[i].setStartDate(Date.valueOf(
					LocalDate.of((2000 + random.nextInt(20)), (random.nextInt(11) + 1), (random.nextInt(27) + 1))));
